// Simple in-memory storage with module-level persistence
// This ensures data persists during the application lifecycle
...
export function updateMockProperty(id, updates) {
  if (mockData.properties[id]) {
    ...
    console.log('Property updated in mock data:', mockData.properties[id]);
